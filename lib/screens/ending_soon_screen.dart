        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(l10n.couldNotLoadDeals, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
  ...
  Widget build(BuildContext context) => Center(
        child: Padding(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Icon(Icons.timer_off_rounded, size: 48, color: AppColors.textMuted),
              const SizedBox(height: 16),
              Text(l10n.noDealsFound, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
              const SizedBox(height: 6),
